    ...
    <div className="col-right">
      ...
      {!suggestion ? (
        <div className="empty">
          ...
          <span>Select a listing and click Run optimizer to see AI recommendations</span>
        </div>
      ) : (
        <>
          ...
          {suggestion.tags.length > 0 && (
            <div className="suggestion-section">
              <p className="suggestion-label">Suggested tags</p>
                  ...
                  return (
                    ...
                    >
                      <summary>
                        ...
                        <small>{totalTokens > 0 ? `${totalTokens} tokens · ` : ""}{money(step.estimatedCost)}</small>
                      </summary>
